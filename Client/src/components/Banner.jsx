    ...
    <div className='w-full h-auto overflow-x-hidden'>
      <div className='w-screen h-[650px] relative'>
        ...
        className='w-[400vw] h-full flex transition-transform duration-1000'>
            <img src={data[0]} alt="imgOne" className='w-screen h-full object-cover' 
                loading='priority' />
            <img src={data[1]} alt="imgOne" className='w-screen h-full object-cover' 
                loading='priority' />
            <img src={data[2]} alt="imgOne" className='w-screen h-full object-cover' 
                loading='priority' />
            <img src={data[3]} alt="imgOne" className='w-screen h-full object-cover' 
                loading='priority' />
        </div>
